...
# MOCK: if "true", just pretend to call the cpu REST API
...
echo "  REPORTING_INTERVAL_SEC=$REPORTING_INTERVAL_SEC"
...
while true; do
  ...
  if [[ "$curlrc" != 0 ]]; then
    ...
    # Little extra processing sample here...
    #If cpu > 50.0 send it to the alert topic as well
